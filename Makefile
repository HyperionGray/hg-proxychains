...
.PHONY: deps smoke down logs health ready pycheck unittest test check preflight validate-config validate-image repo-scan repo-scan-json repo-clean repo-scan-all repo-scan-all-json maintenance maintenance-fix maintenance-json maintenance-all maintenance-all-json bundle clean
