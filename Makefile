...
maintenance:
	$(PYTHON) scripts/repo_maintenance.py --root . --no-include-third-party

maintenance-fix:
	$(PYTHON) scripts/repo_maintenance.py --root . --no-include-third-party --fix

maintenance-json:
	$(PYTHON) scripts/repo_maintenance.py --root . --no-include-third-party --json

maintenance-all:
	$(PYTHON) scripts/repo_maintenance.py --root . --include-third-party

maintenance-all-json:
	$(PYTHON) scripts/repo_maintenance.py --root . --include-third-party --json
