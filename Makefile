...
.PHONY: deps smoke down logs health ready pycheck unittest test check quickstart-check validate-image preflight validate-config repo-scan repo-clean repo-scan-json maintenance maintenance-fix maintenance-json maintenance-all maintenance-all-json maintenance-baseline bundle clean
...
quickstart-check: maintenance unittest
