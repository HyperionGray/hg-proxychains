...
By default, scans are first-party only and skip `third_party/`.
Use `--include-third-party` when you explicitly want dependency-internal marker and stray checks.
