...
By default, marker and embedded-git scanning skip `third_party/` to keep
scheduled automation focused on first-party code.
Use `--include-third-party` when you explicitly want full dependency-tree
visibility.
