...
By default, marker scanning skips `third_party/FunkyDNS` so day-to-day automation
stays focused on first-party code. Use `--include-third-party` for full scans.
