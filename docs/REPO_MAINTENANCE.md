...
Primary scanner/cleaner behavior:
...
Use `--include-third-party` when you intentionally want to include
...
- `clean` exits `0` only when no blocking issues remain after cleanup.
