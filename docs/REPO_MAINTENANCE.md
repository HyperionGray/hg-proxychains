...
This note stays focused on wrapper behavior and quick examples.
...
Enable `--include-third-party` when you need to include
`third_party/FunkyDNS` internals in marker and stray checks.
