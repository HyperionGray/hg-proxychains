...
# JSON output for automation
python3 scripts/repo_maintenance.py --root . --json
```
...
- Baseline suppressions come from `.repo-hygiene-baseline.json` by default and can be changed with `--baseline-file`.
