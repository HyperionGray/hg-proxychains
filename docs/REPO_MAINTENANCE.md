...
# Exclude generated trees or one-off paths from scan/clean
python3 scripts/repo_maintenance.py --exclude-glob "docs/generated/**"
python3 scripts/repo_hygiene.py scan --repo-root . --exclude-glob "docs/generated/**"
