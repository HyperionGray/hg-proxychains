...
- Embedded git repositories that are not expected
   (for example nested accidental clones under working directories).
...
- `1`: blocking issues found
  ...
  - `clean`: unfinished markers, tracked stale artifacts, or embedded git repositories
