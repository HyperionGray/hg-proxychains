...
- Known stale artifacts (`egressd-starter.tar.gz`) whether tracked or untracked
- Embedded git repositories outside allowed gitlink/submodule paths
...
- `1`: blocking issues found
  ...
  - `clean`: unfinished markers, tracked stale artifacts, embedded git repos, or undeleted cleanup targets
...
## Automation loop note

- clean up this directory
- Keep `make maintenance` in the scheduled loop and rotate stale artifact
  entries in `scripts/repo_hygiene.py` as new generated bundles appear.
