...
- Unexpected embedded git repositories (nested `.git` directories/files that
  are not legitimate gitlinks)
...
# Remove untracked stray files/directories and stale artifacts
...
- `1`: blocking issues found
  ...
  - `clean`: unfinished markers, embedded git repos, tracked stale artifacts, or removable clutter that could not be deleted
