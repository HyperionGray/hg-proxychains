...
`scripts/repo_maintenance.py` remains a compatibility wrapper for older entry points.
...
use `--include-third-party` for marker, stray, and embedded-git detection.
...
The baseline does not suppress embedded git repo findings.
