...
- Common untracked stray artifacts:
  ...
  - generated/cache clutter that should never be committed
- Known stale artifact paths (tracked or untracked), currently:
  - `egressd-starter.tar.gz`
- Embedded git repositories under the repo root that are not valid gitlinks
  to approved submodules.
