...
`scripts/repo_hygiene.py` is the primary scanner and cleanup tool. For scheduled
automation and compatibility with older invocations, `scripts/repo_maintenance.py`
wraps it (`make maintenance` / `make maintenance-fix`).
