...
def collect_git_paths(
    ...
    if include_third_party:
        dep_paths = list_submodule_paths(repo_root, "third_party/FunkyDNS", list_args)
...
def command_clean(
    ...
    remaining_issues = len(findings) + len(stale_tracked)
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=False,
        help="include third_party/FunkyDNS paths in marker and stray scans",
    )
    parser.add_argument(
        "--baseline-file",
