...
def command_scan(
    ...
    *,
    ...
    report = build_scan_report(findings, stray, stale_tracked, stale_untracked, suppressed_markers=suppressed)
    if json_output:
        print(json.dumps(report, indent=2, sort_keys=True))
    else:
        print_scan_results(findings, stray, stale_tracked, stale_untracked, suppressed_markers=suppressed)
...
def command_clean(
    ...
    *,
    ...
    report["clean"] = {
        ...
        "requested_delete_paths": removable,
    }
    ...
    return 1 if findings or stale_tracked or remaining_stray or remaining_stale_untracked else 0
