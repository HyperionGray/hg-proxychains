...
STALE_ARTIFACT_PATHS = frozenset(STALE_ARTIFACT_PATHS)
...
def command_scan(
    ...
    *,
    ...
    has_issues = bool(report["summary"]["total_issues"])
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="treat baseline-suppressed unfinished markers as blocking failures",
    )
