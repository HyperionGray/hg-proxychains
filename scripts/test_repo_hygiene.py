...
class RepoHygieneTests(unittest.TestCase):
    ...
    def test_find_stale_artifacts_detects_tracked_bundle(self) -> None:
    ...
    def test_discover_embedded_git_repos_allows_expected_submodule_gitlink(self) -> None:
