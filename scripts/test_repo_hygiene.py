...
class RepoHygieneTests(unittest.TestCase):
    ...
    def test_find_stale_artifacts_reports_tracked_and_untracked(self) -> None:
        ...
        untracked = ["tmp/cache.tmp", "egressd-starter.tar.gz"]
    ...
    def test_discover_embedded_git_repos_honors_third_party_flag(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            root = Path(td)
            (root / ".git").mkdir()
        ...
        self.assertEqual(include_scan, ["third_party/FunkyDNS/scratch"])
