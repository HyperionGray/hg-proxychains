...
`make maintenance-baseline` refreshes `.repo-hygiene-baseline.json` from the
current full-repo marker set, which is useful after intentionally resolving or
accepting upstream dependency markers.
