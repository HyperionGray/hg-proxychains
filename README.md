...
Run repository maintenance checks for first-party code:

- unfinished markers in tracked source files
- untracked stray artifacts (backup/temp files and cache outputs)
...
For automatic cleanup of removable clutter (untracked stray artifacts and stale untracked artifacts):
...
For scheduled automation, keep this check in the loop to catch new TODO/STUB markers, stale artifacts, and stray embedded repositories early.
