...
For scheduled automation, keep this check in the loop to catch new TODO/STUB markers, stale bundle artifacts, and accidental embedded nested repositories early.
