...
`make maintenance-baseline` refreshes `.repo-hygiene-baseline.json` from current
marker findings (typically used with third-party marker debt that should not
fail first-party scheduled checks).
