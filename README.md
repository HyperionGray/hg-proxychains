...
For scheduled automation, keep this check in the loop to catch new TODO/STUB markers, stale generated artifacts, stray files, and unexpected embedded git repositories early.
